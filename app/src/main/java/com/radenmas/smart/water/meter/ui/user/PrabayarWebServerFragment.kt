...
import com.radenmas.smart.water.meter.databinding.FragmentWebServerPrabayarBinding
import com.radenmas.smart.water.meter.network.Config
import com.radenmas.smart.water.meter.utils.Utils


class PrabayarWebServerFragment : Fragment() {

    private lateinit var b: FragmentWebServerPrabayarBinding
    ...
    override fun onCreateView(
        ...
        b = FragmentWebServerPrabayarBinding.inflate(layoutInflater, container, false)
        val v = b.root
